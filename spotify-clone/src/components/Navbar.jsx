        ...
        <>
            <div className='w-full flex justify-between items-center font-semibold'>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <p className='bg-purple-500 text-black w-7 h-7 rounded-full flex items-center justify-center transition-transform duration-200 hover:bg-purple-400 hover:scale-105'>NV</p>
                </div>
            </div>
