...
const Sidebar = () => {
    return (
        <div className='w-[35%] h-[69%] p-2 flex-col gap-2 text-white hidden lg:flex'>
            ...
            <div className="mb-[-60px] pl-6 eng-btn flex items-center">
                <button className="px-2.5 py-0.5 bg-transparent border border-gray-500 text-white font-bold rounded-[20px] mt-4 hover:scale-105 hover:border-white flex items-center gap-2">
